...
//    private int uTextureSamplerLocation = -1;
    ...
    public FilterEngine(int OESTextureId, Context context) {
        ...
        vertexShader = loadShader(GL_VERTEX_SHADER, ShaderUtil.loadFromAssetsFile("camera_vertex.glsl", mContext.getResources()));
        fragmentShader = loadShader(GL_FRAGMENT_SHADER, ShaderUtil.loadFromAssetsFile("camera_fragment.glsl", mContext.getResources()));
